...
impl PixelRGB24 {
    ...
    pub fn nice_red() -> Self { Self::from_hex(0xB2000E) }
    pub fn nice_blue() -> Self { Self::from_hex(0x0009B2) }
    pub fn nice_green() -> Self { Self::from_hex(0x00B22B) }
    pub fn nice_yellow() -> Self { Self::from_hex(0xFFD119) }
}

impl BW for PixelRGB24 {
    fn black() -> Self { Self{r: 0x00, g: 0x00, b: 0x00} }
    fn white() -> Self { Self{r: 0xff, g: 0xff, b: 0xff} }
}

impl RGB for PixelRGB24 {
    fn red()   -> Self { Self::nice_red() }
    fn green() -> Self { Self::nice_green() }
    fn blue()  -> Self { Self::nice_blue() }
}
...
impl BW for PixelG8 {
    fn black() -> Self { Self(0xff) }
    fn white() -> Self { Self(0x00) }
}

impl RGB for PixelG8 {
    fn red()   -> Self { Self(0b0010_0000) }
    fn green() -> Self { Self(0b0100_0000) }
    fn blue()  -> Self { Self(0b1000_0000) }
}
